...
export const findAll = (locate) => request(`${SEARCH_URL}${locate}.json?access_token=${ACCESS_TOKEN}`, "get");
...
//   );
export const nisc_bus = ({ lon = 120, lat = 20, radius = 250 }) =>
  api.get(`${URL}/nisc/bus`, { params: { lon, lat, radius } });

export const nisc_bus_v2 = ({ type = "bus", lon = 120, lat = 20, radius = 250 }) =>
  api.get(`${URL}/nisc/v2`, { params: { type, lon, lat, radius } });
